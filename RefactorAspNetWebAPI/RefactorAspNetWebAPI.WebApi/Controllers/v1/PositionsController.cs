...
using RefactorAspNetWebAPI.Application.Features.Positions.Commands.DeletePositionById;
using RefactorAspNetWebAPI.Application.Features.Positions.Commands.UpdatePosition;
using RefactorAspNetWebAPI.Application.Features.Positions.Queries.GetPositionById;
...
namespace RefactorAspNetWebAPI.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
